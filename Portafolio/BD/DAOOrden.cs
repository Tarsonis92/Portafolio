...
namespace BD
{
    public class DAOOrden
    {
      ...
      // hay que tener ojo con el datetime 
        ...
        public void Actualizar_Orden(int id_orden, DateTime fecha_hora, int id_factura, int id_mesa)
        {
            try
            {
        ...
        public void Agregar_Orden(int id_orden, DateTime fecha_hora, int id_factura, int id_mesa)
        {
            try
            {
                con.Open();
