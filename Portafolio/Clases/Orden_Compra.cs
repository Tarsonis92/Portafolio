...
namespace Clases
{
    class Orden_Compra
    {
        ...
        public int Proveedor_id_proveedor { get => proveedor_id_proveedor; set => proveedor_id_proveedor = value; }
        public int Usuario_id_usuario { get => usuario_id_usuario; set => usuario_id_usuario = value; }
        public int Tipo_usuario_id_tipo { get => tipo_usuario_id_tipo; set => tipo_usuario_id_tipo = value; }
    }
}
